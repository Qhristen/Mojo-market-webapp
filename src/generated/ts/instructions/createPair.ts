...
export const CREATE_PAIR_DISCRIMINATOR = new Uint8Array([
  156, 190, 126, 151, 163, 62, 192, 220,
]);

export function getCreatePairDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(CREATE_PAIR_DISCRIMINATOR);
}

export type CreatePairInstruction<
...
export function getCreatePairInstructionDataCodec(): Codec<
  CreatePairInstructionDataArgs,
  CreatePairInstructionData
> {
  return combineCodec(
    getCreatePairInstructionDataEncoder(),
    getCreatePairInstructionDataDecoder()
  );
}

export type CreatePairAsyncInput<
...
> {
  ...
  if (!accounts.pairedVault.value) {
    accounts.pairedVault.value = await getProgramDerivedAddress({
      programAddress:
        'ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL' as Address<'ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL'>,
      seeds: [
        getAddressEncoder().encode(expectAddress(accounts.pair.value)),
...
export type ParsedCreatePairInstruction<
  TProgram extends string = typeof MOJO_CONTRACT_PROGRAM_ADDRESS,
...
> = {
  ...
  accounts: {
    ...
    platformState: TAccountMetas[7];
    tokenProgram: TAccountMetas[8];
    associatedTokenProgram: TAccountMetas[9];
    systemProgram: TAccountMetas[10];
    rent: TAccountMetas[11];
  };
  data: CreatePairInstructionData;
};

export function parseCreatePairInstruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedCreatePairInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getCreatePairInstructionDataDecoder().decode(instruction.data),
  };
}
