...
const playerData: Player[] = [
  ...
  },
  {
    ...
    appearances: 33,
    image:
      'https://img.fcbayern.com/image/upload/t_cms-1x1-seo/v1692344059/cms/public/images/fcbayern-com/players/season-23-24/kane.png',
    leagueBadge: 'BL',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    appearances: 36,
    image:
      'https://www.fcbarcelona.com/photo-resources/2023/09/20/ae5188d8-67fd-4229-9544-801a16a02091/09-ROBERT_LEWANDOWSKI.jpg',
    leagueBadge: 'LL',
  },
]
              ...
              <Select onValueChange={(e) => setSelectedLeague(e)}>
                ...
                <SelectContent>
                  {leagues.map((league, i) => (
                    <SelectItem key={i} value={league.name}>
                      {' '}
                      {league.name}
                    </SelectItem>
                  ))}
